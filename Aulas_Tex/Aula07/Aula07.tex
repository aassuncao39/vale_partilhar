...
\begin{itemize}
	\item Introdução;
	\item Consulta de dados em repositórios online;
	\item Familiarização com os dados;
	\item Orientações Gerais;
	\item Link do projeto;
\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_12}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_13}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_14}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_15}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_16}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_17}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/slide_18}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Consulta de dados em repositórios online}
	\textbf{Diferenças: Metadados X Arquivo Vetorial}
	\begin{itemize}
		\item O que compõe um Metadado?
		\item Um Metadado pode complementar um arquivo vetorial? Se sim, porque?
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	Instruções do projeto estão disponíveis em:
	\href{https://github.com/aassuncao39/vale_partilhar/blob/main/Aulas_Tex/Aula07/projeto_fogo_gis.md}{Github}
\end{frame}
