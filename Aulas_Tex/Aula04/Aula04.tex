...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout1}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.2\textwidth]{./image/layout2}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout3}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout4}
	\end{figure}
\end{frame}
\begin{frame}
	\frametitle{Compositor de impressão}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout5}
	\end{figure}
\end{frame}
\begin{frame}
	\frametitle{Compositor de impressão}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout6}
	\end{figure}
\end{frame}
\begin{frame}
	\frametitle{Compositor de impressão}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout7}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/layout8}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Compositor de impressão}
	\begin{itemize}
		\item Para a próxima aula, crie um layout com o dado matricial e exporte o layout. Caso tenham dúvida, se inspirem nos slides a seguir
	\end{itemize}
\end{frame}
