...
\begin{document}
	\author[Aula 03]{Dados vetoriais, dados rasters e compositor de impressão}
	\title[Dados vetoriais, dados rasters]{Como dominar o mundo com geoprocessamento}
	\subtitle{Aula 03}
...
% Conteúdo
\begin{frame}
\frametitle{Sumário da Aula 03}
\large
\begin{itemize}
	\item Criação e importação de dados vetoriais;
...
\begin{frame}
	\frametitle{Abrir o QGIS}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/abrir_qgis}
	\end{figure}
\end{frame}

\begin{frame}
	\frametitle{Importar a imagem "imagem\_mineirao.tif"}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/imagem_mineirao.png}
	\end{figure}
\end{frame}

\begin{frame}
	\frametitle{Criação e importação de dados vetoriais}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/criar_nova_camada.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{./image/salvar_camada.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/vetorizar_pontos_mineirao.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/salvar_edicao.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{./image/abrir_atributos.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/vetor_7}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/pontos_pra_linhas.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/vetor_9}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/ferramenta_linhas_poligonos.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/poligono_mineirao.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/criar_circulo.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/mineirao_mineirinho.png}
	\end{figure}
\end{frame}


\begin{frame}
	\frametitle{Importação e união de dados alfanuméricos}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{./image/inserir_vetor.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/aproximara_para.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{./image/arrastar_tabela.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.4\textwidth]{./image/abrir_propriedades.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{./image/join_table.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\textwidth]{./image/simbologia_jenks.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Importação e união de dados alfanuméricos}
	\begin{itemize}
		\item Qual o bairro mais populoso de BH?
		\item Qual o bairro mais povoado de BH?
	\end{itemize}
\end{frame}
